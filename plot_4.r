...
with(mydata, plot(Voltage ~ mydate,type="l",xlab="datetime", ylab="Voltage",cex.axis=0.7,cex.lab=0.7))
...
with(mydata, {
				...
				legend("topright", paste("Sub_metering_", 1:3,sep=""),col=c("black","red","blue"),lwd=2,cex=0.7,bty="n")
			}
)

with(mydata, plot(Global_reactive_power ~ mydate,type="l",xlab="Global_reactive_power", ylab="Voltage",cex.axis=0.7,cex.lab=0.7))
# turn the device off
dev.off()
